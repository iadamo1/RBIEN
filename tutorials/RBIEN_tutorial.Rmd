...
#The number of species this time is 1100.This discrepancy is due to the different criteria for the species to be returned in the two functions. The criteria for the species to be returned function BIEN_list_country() are less restrictive than the criteria used in the BIEN_occurrence_country()function. the BIEN_list_country() might include species for which the coordinates don't fall within the specified country or there is some missing taxonomic information in the TRNS. (Brian Maitner). 
